...
export const mapToBooking = (dbData: any): Booking => {
  ...
  return {
    ...
    homeVisitLatitude: dbData.home_visit_latitude || dbData.home_visit_coordinates?.lat,
    homeVisitLongitude: dbData.home_visit_longitude || dbData.home_visit_coordinates?.lng,
    notes: dbData.notes,
    totalAmount,
