...
const NAV_ITEMS: NavItem[] = [
    ...
    },
    {
        ...
        roles: ['owner', 'admin', 'superadmin'],
        children: [
            { title: 'Tampilan', path: '/settings/appearance', icon: 'palette' },
            { title: 'Media', path: '/settings/media', icon: 'image' },
            { title: 'Contact Link', path: '/settings/contact', icon: 'link' },
            { title: 'Kalender', path: '/settings/calendar', icon: 'calendar' },
            { title: 'Invoice', path: '/settings/invoice', icon: 'receipt' },
        ]
    },
    {
        title: 'Profile',
