...
export function UnifiedBookingPanel({
  ...
  const handleSendWhatsApp = () => {
    ...
    const date = new Date(booking.scheduledAt).toLocaleDateString('id-ID', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' });
    ...
    switch (whatsAppTemplate) {
      case 'confirmation':
        ...
        break;
      case 'reminder':
        message = `Halo ${customerName}, mengingatkan kembali untuk booking Anda besok ${date} pukul ${time} untuk ${serviceName}. Sampai jumpa!`;
        break;
      case 'payment':
        message = `Halo ${customerName}, mohon selesaikan pembayaran sebesar ${amount} untuk booking ${bookingNumber}. Terima kasih.`;
        break;
      case 'completion':
        message = `Halo ${customerName}, terima kasih telah menggunakan layanan kami. Semoga Anda puas dengan hasilnya!`;
        break;
      default:
        message = `Halo ${customerName}, ini info mengenai booking Anda ${bookingNumber}.`;
    }
      ...
      <div className="p-6 border-b border-gray-100 bg-white z-10">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <Button variant="outline" onClick={() => setShowWhatsAppDialog(true)} className="border-green-200 text-green-700 hover:bg-green-50 hover:border-green-300">
              <i className='bx bxl-whatsapp text-lg mr-2'></i> Reminder
            </Button>
